...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="WorkspaceRole",
            fields=[
                ("id", models.UUIDField(default=uuid.uuid4, editable=False, help_text="Unique role ID", primary_key=True, serialize=False)),
                (
                    "type",
                    models.CharField(
                        choices=[("owner", "Owner"), ("member", "Member")], default="member", help_text="Type of the role", max_length=20
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, help_text="Creation timestamp")),
                ("updated_at", models.DateTimeField(auto_now=True, help_text="Last update timestamp")),
                ...
                (
                    "workspace",
                    models.ForeignKey(
                        help_text="Workspace", on_delete=django.db.models.deletion.CASCADE, related_name="roles", to="workspaces.workspace"
                    ),
                ),
            ],
            options={
